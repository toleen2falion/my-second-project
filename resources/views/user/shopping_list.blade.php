...
<main  lang="ar" dir="rtl" class="primary-text">
...
<div class="container-fluid py-5">
    ...
    @endif
              <div class="card-header text-warning text-center fw-bold">
                <span><i class=""></i></span>  المكونات الغذائية      
              </div>
                                ...
                                @endphp
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                             ...
                                             <a class="btn btn-outline-danger btn-sm p-0"
                                                 href="{{ url('/userRegistered/dashboard/remove_from_shopping_list') }}/{{ $SL->ingredient_id }}"
                                                 role="button">
